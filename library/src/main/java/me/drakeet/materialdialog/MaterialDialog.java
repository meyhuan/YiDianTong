...
public class MaterialDialog {
    ...
    private int mBottomLayoutVisibility;
    ...
    public MaterialDialog setButtonLayoutVisiable(int visiable) {
        mBottomLayoutVisibility = visiable;
        if (mBuilder != null) {
            mBuilder.setButtonLayoutVisiable(visiable);
        }
        return this;
    }
    ...
    private class Builder {
        ...
        private RelativeLayout mButtonLayoutParent;
        ...
        private Builder() {
            ...
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                    R.id.buttonLayout);
            mButtonLayoutParent = (RelativeLayout) mAlertDialogWindow.findViewById(
                    R.id.material_bottom_layout);
        ...
        public void setButtonLayoutVisiable(int visiable) {
            if (mMessageView != null) {
                mButtonLayoutParent.setVisibility(visiable);
            }
        }
