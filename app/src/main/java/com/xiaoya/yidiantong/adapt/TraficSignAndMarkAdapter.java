 ...
 */
public class TraficSignAndMarkAdapter extends SimpleBaseAdapter<TraficSignAndMarkModel>{
    public TraficSignAndMarkAdapter(Context paramContext) {
        super(paramContext);
    }

    public TraficSignAndMarkAdapter(Context paramContext, List<TraficSignAndMarkModel> paramList) {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
        ...
        if (paramView == null) {
            ...
            paramView = getInflater().inflate(R.layout.item_trafic_sign, null);
        ...
        String title = localTraficSignAndMarkModel.getName() ;
